...
public class Client extends User{
    ...
    public Client(String clientId, String name, String surname, String adress, Integer dni, Date birthDate, String nationality, Long phoneNumb, String email, Date lastInteract, boolean status) {
